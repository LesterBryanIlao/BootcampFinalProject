		                ...
		                <div class="row">
		                    <div class="col-xs-10 col-sm-5 col-md-5 col-lg-4">
		                        <div class="post-type post-img">
		                         <img src="https://www.worldfuturecouncil.org/wp-content/uploads/2020/06/blank-profile-picture-973460_1280-1-705x705.png" 
		                                >
		                        </div>
		                            ...
		                            <ul class="list-inline">
		                                <li>
		                                    <div class="info">
			                                        ...
			                                        <p><c:out value="Hello ${post.getUser().getUserName()}"></c:out></p>
			                                        <p>Posted on:</p>
